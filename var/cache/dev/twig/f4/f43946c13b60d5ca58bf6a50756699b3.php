...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const currentUserId = ";
        // line 179
        echo twig_escape_filter($this->env, (isset($context["iduser1"]) || array_key_exists("iduser1", $context) ? $context["iduser1"] : (function () { throw new RuntimeError('Variable "iduser1" does not exist.', 179, $this->source); })()), "html", null, true);
        echo ";
    const receiverId = ";
        // line 180
        echo twig_escape_filter($this->env, (isset($context["iduser2"]) || array_key_exists("iduser2", $context) ? $context["iduser2"] : (function () { throw new RuntimeError('Variable "iduser2" does not exist.', 180, $this->source); })()), "html", null, true);
        echo ";

    // Format the lastDateMsg1 and lastDateMsg2 as strings
    const formattedLastDateMsg1 = '";
        // line 183
        (((isset($context["lastDateMsg1"]) || array_key_exists("lastDateMsg1", $context) ? $context["lastDateMsg1"] : (function () { throw new RuntimeError('Variable "lastDateMsg1" does not exist.', 183, $this->source); })())) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["lastDateMsg1"]) || array_key_exists("lastDateMsg1", $context) ? $context["lastDateMsg1"] : (function () { throw new RuntimeError('Variable "lastDateMsg1" does not exist.', 183, $this->source); })()), "format", ["Y-m-d H:i:s"], "method", false, false, false, 183), "html", null, true))) : (print ("")));
        echo "';
    const formattedLastDateMsg2 = '";
        // line 184
        (((isset($context["lastDateMsg2"]) || array_key_exists("lastDateMsg2", $context) ? $context["lastDateMsg2"] : (function () { throw new RuntimeError('Variable "lastDateMsg2" does not exist.', 184, $this->source); })())) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["lastDateMsg2"]) || array_key_exists("lastDateMsg2", $context) ? $context["lastDateMsg2"] : (function () { throw new RuntimeError('Variable "lastDateMsg2" does not exist.', 184, $this->source); })()), "format", ["Y-m-d H:i:s"], "method", false, false, false, 184), "html", null, true))) : (print ("")));
        echo "';

    const eventSource = new EventSource(
        '";
        // line 187
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("sse_conversations", ["user1Id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 187, $this->source); })()), "request", [], "any", false, false, false, 187), "attributes", [], "any", false, false, false, 187), "get", ["user1Id"], "method", false, false, false, 187), "user2Id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 187, $this->source); })()), "request", [], "any", false, false, false, 187), "attributes", [], "any", false, false, false, 187), "get", ["user2Id"], "method", false, false, false, 187)]), "html", null, true);
        echo "' +
...
";
    ...
    {
        return array (  322 => 187,  316 => 184,  312 => 183,  306 => 180,  302 => 179,  263 => 143,  258 => 140,  251 => 138,  243 => 135,  239 => 134,  236 => 133,  231 => 132,  227 => 131,  222 => 128,  215 => 126,  207 => 123,  203 => 122,  198 => 120,  195 => 119,  190 => 118,  186 => 117,  178 => 112,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "conversation/index.html.twig", "C:\\Users\\hamad\\OneDrive\\Desktop\\WebSymfony\\templates\\conversation\\index.html.twig");
    }
}
