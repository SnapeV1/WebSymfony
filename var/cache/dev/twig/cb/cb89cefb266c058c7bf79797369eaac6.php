...
/* eventadmin/getall.html.twig */
class __TwigTemplate_d6d3262ea8f25067040fd241f409308a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "eventadmin/getall.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "eventadmin/getall.html.twig"));

        $this->parent = $this->loadTemplate("connected.html.twig", "eventadmin/getall.html.twig", 1);
    ...
    <div class=\"container text-center\">
        ...
        echo "                </tbody>
         ...
         <div class=\"text-center mt-3\">
                <a href=\"";
        // line 45
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("eventadmin_add_form");
        echo "\" class=\"btn btn-success\">Add Event</a>
                <!-- Replace 'your_add_route_here' with the actual route for adding events -->
            </div>

             <div class=\"text-center mt-3\">
                <a href=\"";
        // line 50
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("rev_getall");
        echo "\" class=\"btn btn-info\">Reservations</a>
                <!-- Replace 'your_reservations_route_here' with the actual route for reservations -->
            </div>
    </div>
";
    ...
    {
        return "eventadmin/getall.html.twig";
    }
    ...
    {
        return array (  155 => 50,  147 => 45,  141 => 41,  129 => 35,  124 => 33,  118 => 30,  114 => 29,  110 => 28,  106 => 27,  102 => 26,  98 => 25,  95 => 24,  91 => 23,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container text-center\">
        ...
        <div class=\"mx-auto\" style=\"width: 70%;\">
         ...
         <div class=\"text-center mt-3\">
                <a href=\"{{ path('eventadmin_add_form') }}\" class=\"btn btn-success\">Add Event</a>
                <!-- Replace 'your_add_route_here' with the actual route for adding events -->
            </div>

             <div class=\"text-center mt-3\">
                <a href=\"{{ path('rev_getall') }}\" class=\"btn btn-info\">Reservations</a>
                <!-- Replace 'your_reservations_route_here' with the actual route for reservations -->
            </div>
    </div>
{% endblock %}
", "eventadmin/getall.html.twig", "C:\\Users\\hamad\\OneDrive\\Desktop\\WebSymfony\\templates\\eventadmin\\getall.html.twig");
    }
}
