 ...
 */
class getEventAdminRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventAdminRepository' shared autowired service.
     *
     * @return \App\Repository\EventAdminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventAdminRepository.php';

        return $container->privates['App\\Repository\\EventAdminRepository'] = new \App\Repository\EventAdminRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
