...
return [
    ...
    'Product_updated_admin' => [['id'], ['_controller' => 'App\\Controller\\AdminController::updateproduct'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/updateadproduct']], [], [], []],
    ...
    'search_products' => [[], ['_controller' => 'App\\Controller\\ProductController::searchByCriteria'], [], [['text', '/search/products']], [], [], []],
